// Хелпери розгортання відповідей API. Мутатор (`@repo/api` customInstance) інколи
// віддає payload напряму, інколи загорнутий у `{ data }` — ці утиліти зводять обидва
// випадки до одного. Раніше були скопійовані в кожній сторінці artist-dashboard;
// тримаємо одну копію тут.
