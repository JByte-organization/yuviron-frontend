...
import { usePostApiAdminGenres, postApiFilesUpload } from '@repo/api/admin.ts';
...
export const CreateGenreModal = ({ isOpen, onClose, onSuccess }: Props) => {
    const {
        register,
        handleSubmit,
        setError,
    ...
    const { mutateAsync: createGenre, isPending } = usePostApiAdminGenres();
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            if (status === 400 && serverErrors) {
                ...
                setError('root', { message: `Error ${status}: Failed to create genre.` });
            }
        }
    };
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content bg-admin-primary border border-secondary shadow-lg text-white">
                    ...
                    <div className="modal-header border-secondary p-4">
                        <h5 className="modal-title fw-bold text-cyan">Create Genre</h5>
