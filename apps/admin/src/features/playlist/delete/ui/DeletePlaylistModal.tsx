...
export const DeletePlaylistModal = ({ playlist, isOpen, onClose, onSuccess }: Props) => {
    const { mutateAsync: deletePlaylist, isPending } = useDeleteApiAdminPlaylistsId();
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            alert(`Error ${status}: Failed to delete playlist.`);
        }
    };
            ...
            <div className="modal-dialog modal-dialog-centered modal-sm">
                <div className="modal-content bg-admin-primary border border-danger shadow-lg text-white">
                    ...
                    <div className="modal-header border-secondary p-4">
                        <h5 className="modal-title fw-bold text-danger">Delete Playlist</h5>
                    ...
                    <div className="modal-body p-4 text-center">
                        ...
                        <p className="fw-bold text-danger fs-5 mb-1">"{playlist.title}"</p>
